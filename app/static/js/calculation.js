...
const calculate = (data, evt) => {
  ...
  const {cardiovascularDisease, diabetes, chronicRespitoryDisease, hypertension, cancer, ageRange, sex} = data
  ...
  const pct = R.reduce(conditionCalc, 0, [ageRate, cardiovascularDiseaseRate, diabetesRate, chronicRespitoryDiseaseRate, hypertensionRate, cancerRate])*sexMultiplier
